...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--gpu_ids', type=str, default='-1', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU') # turning 0 to -1
        ...
        parser.add_argument('--z_dim', type=int, default=256, #256->512
